...
QUESTION_TYPE = [0,0,0,0,1, 0,1,0,0]

#每一题有多少个选项
SELECTION_COUNT = [4,2,2,3,5, 4,7,2,2]

#每个选项的概率，是一个二维列表
SELECTION_PORBABILITY = [
    [25,25,25,25],[50,50],[80,20],[33,33,34],[50,50,50,50,50],
    [25,25,25,25],[50,50,50,50,50,50,50],[50,50],[50,50]
]
