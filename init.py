...
QUESTION_TYPE = [0,0,0,0,0, 0,0,0,3,3, 1]

#每一题有多少个选项
SELECTION_COUNT = [2,4,7,4,2, 5,5,4,4,4, 4]

#每个选项的概率，是一个二维列表
SELECTION_PORBABILITY = [
    [60,40],[30,40,20,10],[10,20,40,0,10,10,10],[10,50,30,10],[60,40],
    [60,5,20,5,10],[20,40,10,25,5],[20,50,0,30],[20,30,40,10],['-3'],
    [60,40,60,80]
]
