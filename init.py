...
QUESTION_TYPE = [0,0,0,0,0, 0,0,0,3,0, 1]

#每一题有多少个选项
SELECTION_COUNT = [2,4,6,4,2, 5,5,4,4,4, 4]

#每个选项的概率，是一个二维列表
SELECTION_PORBABILITY = [
    [60,40],[0,50,30,20],[10,30,40,0,10,10],[10,50,30,10],[30,70],
    [60,5,20,5,10],[20,40,10,25,5],[0,0,100,0],['-3'],[40,30,20,10],
    [60,40,60,80]
]
